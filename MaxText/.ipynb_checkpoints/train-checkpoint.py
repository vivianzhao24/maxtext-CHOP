...
# pylint: disable=g-bad-todo, abstract-method,JAX_FORCE_TPU_INIT=true LIBTPU_INIT_ARGS='--xla_tpu_use_minor_sharding_for_major_trivial_input=true --xla_tpu_relayout_group_size_threshold_for_reduce_scatter=1 --xla_tpu_scoped_vmem_limit_kib=98304 --xla_tpu_enable_data_parallel_all_reduce_opt=true --xla_tpu_data_parallel_opt_different_sized_ops=true --xla_tpu_enable_async_collective_fusion=true --xla_tpu_enable_async_collective_fusion_fuse_all_gather=true --xla_tpu_enable_async_collective_fusion_multiple_steps=true --xla_tpu_overlap_compute_collective_tc=true --xla_enable_async_all_gather=true' \py consider-using-with, ungrouped-imports
  ...
  if dataset_type == "grain":
    ...
    return checkpoint_manager.save(
      ...
      args=orbax.checkpoint.args.Composite(
        ...
        iter=checkpointing.TfDataCheckpointSave(item=data_iterator.local_iterator, step=step),
      ),
    )
  else:
    return checkpoint_manager.save(
...
def train_loop(config, state=None):
  ...
  print("Starting step is", start_step)
  print()
