...
export DATASET_NAME='gs://scit1565-pedsllm-b5-south1/datasets/notes_replay_combined/1.0/'
export BASE_OUTPUT_PATH=gs://scit1565-pedsllm-b5-south1
...
export CONVERTED_CHECKPOINT=${BASE_OUTPUT_PATH}/test_iter_checkpointing/checkpoints/0/items
